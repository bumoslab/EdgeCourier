# from .pkg_resources import pkg_resources 
...
# print(_TRUSTED_CERT_FILE, type(_TRUSTED_CERT_FILE))
_TRUSTED_CERT_FILE = os.path.abspath(os.getcwd() + '/dropbox/trusted-certs.crt') 
print(_TRUSTED_CERT_FILE, type(_TRUSTED_CERT_FILE))
...
class BaseSession(object):
    ...
    def build_path(self, target, params=None):
        ...
        This method urlencodes the parameters, afds them
