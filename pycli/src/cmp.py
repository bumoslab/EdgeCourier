...
class docdiff:
    ...
    def diff_files(self, ofname, nfname):
        ...
        f1 = open(ofname, 'r').read().decode('utf-8')
        f2 = open(nfname, 'r').read().decode('utf-8')
    ...
    def patch_files(self, ofname, patch):
        ...
        f.seek(0)
        f.write(recover[0].encode('utf-8'))
        f.truncate()
        f.close()
...
if __name__ == "__main__":
    ...
    p = d.diff_files(sys.argv[1], sys.argv[2])
    print(d.PatchtoText(p))
